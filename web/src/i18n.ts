...
export const STRINGS = {
  en: {
    ...
    linkedin: 'LinkedIn',
    wechat: 'WeChat',
    wechatAdd: 'Add on WeChat',
    wechatQrAlt: 'WeChat QR code',
    wechatHintInApp: 'Press and hold the code, then choose “Extract QR Code”.',
    wechatHintOutside:
      'Save this image, then open WeChat → Scan → album. Or just copy the ID below.',
    wechatSteps: 'Open WeChat → Search → paste the ID → Add.',
    copy: 'Copy',
    copied: 'Copied',
    close: 'Close',
    email: 'Email',
  ...
  zh: {
    ...
    wechatAdd: '添加微信',
    wechatQrAlt: '微信二维码',
    wechatHintInApp: '长按二维码 → 识别图中二维码',
    wechatHintOutside: '保存图片，再用微信「扫一扫」→ 相册。或直接复制下面的微信号。',
    wechatSteps: '打开微信 → 搜索 → 粘贴微信号 → 添加。',
    copy: '复制',
    copied: '已复制',
    close: '关闭',
    email: '邮箱',
